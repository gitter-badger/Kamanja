...
lazy val Exceptions = project.in(file("Exceptions")) dependsOn(KamanjaVersion, ExtDependencyLibs)
...
lazy val KamanjaManager = project.in(file("KamanjaManager")) dependsOn(KamanjaDependencyLibs, )
