...
cp $srcPath/lib_managed/bundles/io.netty/netty/netty-3.7.0.Final.jar $systemlib
...
cp $srcPath/Storage/SqlServer/target/scala-2.10/sqlserver_2.10-0.1.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/junit/junit/junit-3.8.1.jar $systemlib
...
cp $srcPath/FileDataConsumer/target/scala-2.10/filedataconsumer_2.10-0.1.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/commons-logging/commons-logging/commons-logging-1.1.1.jar $systemlib
