...
cp Utils/NodeInfoExtract/target/scala-2.11/NodeInfoExtract* $bin
...
cp $srcPath/InputOutputAdapters/IbmMqSimpleInputOutputAdapters/target/scala-2.11/ibmmqsimpleinputoutputadapters_2.11-1.0.jar $systemlib
...
cp $srcPath/Utils/SaveContainerDataComponent/target/scala-2.11/savecontainerdatacomponent*.jar $systemlib
