...
cp $srcPath/lib_managed/jars/com.typesafe.akka/akka-actor_2.10/akka-actor_2.10-2.3.2.jar $systemlib
...
cp $srcPath/Storage/Cassandra/target/scala-2.10/cassandra_2.10-0.1.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.ow2.asm/asm-commons/asm-commons-4.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/junit/junit/junit-4.11.jar $systemlib
...
cp $srcPath/Storage/TreeMap/target/scala-2.10/treemap_2.10-0.1.0.jar $systemlib
...
cp $srcPath/lib_managed/bundles/com.typesafe/config/config-1.2.0.jar $systemlib
...
cp $ivyPath/cache/joda-time/joda-time/jars/joda-time-2.9-javadoc.jar $systemlib
cp $srcPath/lib_managed/jars/org.scalamacros/quasiquotes_2.10.4/quasiquotes_2.10.4-2.0.0-M6.jar $systemlib
cp $srcPath/lib_managed/jars/org.jpmml/pmml-agent/pmml-agent-1.2.5.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.apache.hadoop/hadoop-common/hadoop-common-2.4.1.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.codehaus.jackson/jackson-mapper-asl/jackson-mapper-asl-1.8.8.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.apache.hadoop/hadoop-auth/hadoop-auth-2.4.1.jar $systemlib
cp $srcPath/lib_managed/jars/javax.activation/activation/activation-1.1.jar $systemlib
cp $srcPath/lib_managed/jars/org.apache.hadoop/hadoop-annotations/hadoop-annotations-2.4.1.jar $systemlib
...
cp $srcPath/lib_managed/jars/commons-el/commons-el/commons-el-1.0.jar $systemlib
cp $srcPath/Pmml/PmmlUdfs/target/scala-2.10/pmmludfs_2.10-1.0.jar $systemlib
cp $srcPath/lib_managed/jars/commons-pool/commons-pool/commons-pool-1.6.jar $systemlib
...
cp $ivyPath/cache/commons-codec/commons-codec/jars/commons-codec-1.7.jar $systemlib
cp $srcPath/Storage/HashMap/target/scala-2.10/hashmap_2.10-0.1.0.jar $systemlib
...
cp $ivyPath/cache/org.jpmml/pmml-agent/jars/pmml-agent-1.2.5.jar $systemlib
cp $srcPath/HeartBeat/target/scala-2.10/heartbeat_2.10-0.1.0.jar $systemlib
cp $ivyPath/cache/org.jpmml/pmml-evaluator/jars/pmml-evaluator-1.2.4.jar $systemlib
...
cp $srcPath/lib_managed/jars/joda-time/joda-time/joda-time-2.8.2.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.apache.hbase/hbase-protocol/hbase-protocol-0.98.4-hadoop2.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.jpmml/pmml-schema/pmml-schema-1.2.5.jar $systemlib
cp $ivyPath/cache/commons-logging/commons-logging/jars/commons-logging-1.1.1.jar $systemlib
cp $srcPath/lib_managed/bundles/org.apache.curator/curator-recipes/curator-recipes-2.6.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.apache.hbase/hbase-common/hbase-common-0.98.4-hadoop2.jar $systemlib
cp $srcPath/Storage/StorageBase/target/scala-2.10/storagebase_2.10-1.0.jar $systemlib
cp $srcPath/SecurityAdapters/SecurityAdapterBase/target/scala-2.10/securityadapterbase_2.10-1.0.jar $systemlib
...
cp $ivyPath/cache/org.jpmml/pmml-model/jars/pmml-model-1.2.5.jar $systemlib
...
cp $srcPath/Storage/StorageManager/target/scala-2.10/storagemanager_2.10-0.1.0.jar $systemlib
...
cp $ivyPath/cache/org.immunogenomics.gl.voldemort/voldemort/jars/voldemort-1.3.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/tomcat/jasper-runtime/jasper-runtime-5.5.23.jar $systemlib
cp $srcPath/lib_managed/jars/org.ow2.asm/asm-tree/asm-tree-4.0.jar $systemlib
...
cp $ivyPath/cache/io.netty/netty/bundles/netty-3.6.6.Final.jar $systemlib
cp $srcPath/InputOutputAdapters/IbmMqSimpleInputOutputAdapters/lib/com.ibm.msg.client.commonservices.j2se.jar $systemlib
cp $srcPath/lib_managed/jars/org.slf4j/slf4j-log4j12/slf4j-log4j12-1.7.5.jar $systemlib
cp $srcPath/lib_managed/bundles/org.scalatest/scalatest_2.10/scalatest_2.10-2.2.4.jar $systemlib
cp $srcPath/lib_managed/jars/commons-io/commons-io/commons-io-2.4.jar $systemlib
cp $srcPath/lib_managed/jars/org.cloudera.htrace/htrace-core/htrace-core-2.04.jar $systemlib
...
cp $srcPath/lib_managed/bundles/org.apache.curator/curator-client/curator-client-2.6.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.jpmml/pmml-evaluator/pmml-evaluator-1.2.4.jar $systemlib
cp $srcPath/AuditAdapters/AuditAdapterBase/target/scala-2.10/auditadapterbase_2.10-1.0.jar $systemlib
...
cp $srcPath/Storage/Voldemort/target/scala-2.10/voldemort_2.10-0.1.0.jar $systemlib
...
cp $srcPath/lib_managed/bundles/org.apache.curator/curator-framework/curator-framework-2.6.0.jar $systemlib
...
cp $srcPath/Storage/Redis/target/scala-2.10/redis_2.10-0.1.0.jar $systemlib
cp $srcPath/Storage/HBase/target/scala-2.10/hbase_2.10-0.1.0.jar $systemlib
cp $srcPath/lib_managed/jars/jline/jline/jline-0.9.94.jar $systemlib
cp $srcPath/lib_managed/jars/org.codehaus.jackson/jackson-core-asl/jackson-core-asl-1.8.8.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.slf4j/slf4j-api/slf4j-api-1.7.6.jar $systemlib
...
cp $srcPath/lib_managed/jars/com.twitter/chill_2.10/chill_2.10-0.3.6.jar $systemlib
cp $srcPath/lib_managed/jars/net.debasishg/redisclient_2.10/redisclient_2.10-2.13.jar $systemlib
...
cp $srcPath/lib_managed/jars/tomcat/jasper-compiler/jasper-compiler-5.5.23.jar $systemlib
cp $srcPath/lib_managed/jars/org.jpmml/pmml-model/pmml-model-1.2.5.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.apache.commons/commons-math3/commons-math3-3.5.jar $systemlib
...
cp $ivyPath/cache/org.jpmml/pmml-schema/jars/pmml-schema-1.2.5.jar $systemlib
...
cp $srcPath/lib_managed/jars/commons-logging/commons-logging/commons-logging-1.1.3.jar $systemlib
...
cp $srcPath/Utils/UtilitySerivce/target/scala-2.10/utilityservice_2.10-1.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/com.google.code.findbugs/jsr305/jsr305-1.3.9.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.apache.hbase/hbase-client/hbase-client-0.98.4-hadoop2.jar $systemlib
...
cp $ivyPath/cache/joda-time/joda-time/jars/joda-time-2.9.jar $systemlib
...
cp $srcPath/TransactionService/target/scala-2.10/transactionservice_2.10-0.1.0.jar $systemlib
cp $srcPath/lib_managed/jars/com.twitter/chill-java/chill-java-0.3.6.jar $systemlib
cp $srcPath/InputOutputAdapters/InputOutputAdapterBase/target/scala-2.10/inputoutputadapterbase_2.10-1.0.jar $systemlib
...
cp $srcPath/lib_managed/jars/org.scala-lang/scala-compiler/scala-compiler-2.10.0.jar $systemlib
